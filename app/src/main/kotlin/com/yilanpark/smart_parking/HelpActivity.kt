...
import com.yilanpark.base.cancelLoadingDialog
import com.yilanpark.base.showLoadingDialog
import com.yilanpark.base.visible
import com.yilanpark.share.BaseHttp
import com.yilanpark.utils.isWeb
...
class HelpActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (mTitle) {
            ...
            "支付成功" -> {
                val parkId = intent.getStringExtra("parkId") ?: ""
                webView.loadUrl("${BaseHttp.baseImg}forend/wx_pay_succ_ref.hm?parkingInfoId=$parkId")
            }
        }
    }
